...
namespace Gabor2
{
	// https://www.shadertoy.com/view/4ljSRR Gabor^2, by mattz
...
*/
    ...
    thread_local simdfloat cnt = 0.0;

    simdfloat gabor(vec2 p, vec4 q) {
        ...
        simdfloat cr = cos(q0.y);
        simdfloat sr = sin(q0.y);
        ...
        q1.w *= smoothstep(cnt, cnt + 0.5f, iTime * 32.0f);
        ++cnt;
    ...
    vec4 mainImage(vec2 fragCoord) {
        ...
        if (maskAll(iResolution.y >= 200.0)) {
